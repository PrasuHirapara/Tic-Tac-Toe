...
class playBotEasy extends StatefulWidget{
  @override
  State<playBotEasy> createState() => _playBotEasy();
}

class _playBotEasy extends State<playBotEasy> {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Padding(
          ...
          child: Center(child: Text("Easy Bot",style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold,color: Colors.black),)),
        ),
      ),
      body: Container(
